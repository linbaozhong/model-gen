...
func (p *{{lower .StructName}}) Update(x interface{}, id {{index .PrimaryKey 2}}, bean interface{}) (int64,error) {
	...
	db.Where(table.{{.StructName}}.PrimaryKey.Eq(), id).
		Limit(1)
	if build, ok := bean.(orm.ISqlBuilder); ok {
		sm := types.Smap{}
...
func (p *{{lower .StructName}}) UpdateBatch(x interface{}, cond orm.ISqlBuilder, bean interface{}) (int64, error) {
	if bean == nil {
		bean = types.Smap{}
	}
	var (
...
func (p *{{lower .StructName}}) DeleteBatch(x interface{}, cond orm.ISqlBuilder) (int64, error) {
	var (
		i64 int64
		e error
		ids []interface{}
...
func (p *{{lower .StructName}}) SoftDeleteBatch(x interface{}, cond orm.ISqlBuilder) (int64, error) {
	var (
		i64 int64
		e error
		ids []interface{}
...
func (p *{{lower .StructName}}) IDs(x interface{}, cond orm.ISqlBuilder, size, index int) ([]interface{}, error) {
{{if .HasCache}}
	if size == 0 {
		size = {{.CacheLimit}}
	}
...
func (p *{{lower .StructName}}) IDsNoCache(x interface{}, cond orm.ISqlBuilder, size, index int) ([]interface{}, error) {
{{if .HasCache}}
...
func (p *{{lower .StructName}}) GetColumn(x interface{}, col string, cond orm.ISqlBuilder, size, index int) ([]interface{}, error) {
	return getColumn(x,table.{{.StructName}}.TableName, col, cond, size, index)
}

//Sum 对某个字段进行求和
func (p *{{lower .StructName}}) Sum(x interface{}, cond orm.ISqlBuilder, col string) (float64, error) {
	db := getDB(x, table.{{.StructName}}.TableName)
...
//Sums 对某几个字段进行求和
func (p *{{lower .StructName}}) Sums(x interface{}, cond orm.ISqlBuilder, cols ...string) ([]float64, error) {
	if len(cols) == 0 {
...
func (p *{{lower .StructName}}) Count(x interface{}, cond orm.ISqlBuilder) (int64, error) {
{{if .HasCache}}
...
func (p *{{lower .StructName}}) CountNoCache(x interface{}, cond orm.ISqlBuilder) (int64, error) {
	db := getDB(x, table.{{.StructName}}.TableName)
...
func (p *{{lower .StructName}}) Find(x interface{}, cond orm.ISqlBuilder, size, index int) ([]*{{.PackageName}}.{{.StructName}}, error) {
{{if .HasCache}}
...
func (p *{{lower .StructName}}) FindNoCache(x interface{}, cond orm.ISqlBuilder, size, index int) ([]*{{.PackageName}}.{{.StructName}}, error) {
	db := getDB(x, table.{{.StructName}}.TableName)
...
func (p *{{lower .StructName}}) FindMap(x interface{}, cond orm.ISqlBuilder, size, index int) (map[{{index .PrimaryKey 2}}]*{{.PackageName}}.{{.StructName}}, error) {
{{if .HasCache}}
	ids, e := p.IDs(x,cond,size,index)
	if len(ids) == 0 {
		return map[{{index .PrimaryKey 2}}]*{{.PackageName}}.{{.StructName}}{}, e
...
func (p *{{lower .StructName}}) FindOne(x interface{}, cond orm.ISqlBuilder) (bool, *{{.PackageName}}.{{.StructName}}, error) {
	if cond != nil {
		cond.Limit(1)
	}
...
func (p *{{lower .StructName}}) FindOneNoCache(x interface{}, cond orm.ISqlBuilder) (bool, *{{.PackageName}}.{{.StructName}},error) {
	if cond != nil {
		cond.Limit(1)
	}
...
//FindAndCound
func (p *{{lower .StructName}}) FindAndCount(x interface{}, cond orm.ISqlBuilder, size, index int) (i64 int64, ms []*{{.PackageName}}.{{.StructName}}, e error) {
...
func (p *{{lower .StructName}}) QueryInterfaces(x interface{}, cond orm.ISqlBuilder) ([]map[string]interface{}, error) {
	db := getDB(x, table.{{.StructName}}.TableName)
...
func (p *{{lower .StructName}}) Exists(x interface{}, cond orm.ISqlBuilder) (bool, error) {
	db := getDB(x, table.{{.StructName}}.TableName)
...
//OnListChange
func (p *{{lower .StructName}}) OnListChange(x interface{}, cond ...orm.ISqlBuilder) {
	ctx := getContext(x)
	if len(cond) == 0 {
...
func (p *{{lower .StructName}}) SliceToJSON(sls []*{{.PackageName}}.{{.StructName}},cols...orm.TableField) []types.Smap {
	sl := len(sls)
	if sl == 0 {
		return []types.Smap{}
	}
