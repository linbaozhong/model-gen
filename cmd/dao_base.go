...
func queryInterfaces(x *{{.PackageName}}.Session, cond orm.ISqlBuilder) ([]map[string]interface{}, error) {
	sql, e := cond.Select()
	if e != nil {
		return nil, e
	}
...
func getColumn(x interface{}, tablename string, col string, cond orm.ISqlBuilder, size, index int) ([]interface{}, error) {
